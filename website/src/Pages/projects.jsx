  ...
  const [posts, setPosts] = useState([
    {
      ...
      href: '#',
      description:
        'Coming Soon! How I built this portfolio website using AWS Lambda, API Gateway, and DynamoDB',
      date: 'Mar 11, 2024',
      datetime: '2024-03-11',
    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-2 text-lg/8 text-gray-600">Leveraging AWS for the Backend While Exploring Diverse Frontend Technologies</p>
        </div>
